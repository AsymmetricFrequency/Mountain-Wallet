...
import { Text, View, StyleSheet, Platform, Image, Modal, Dimensions} from 'react-native';
...
export const Contraseña = ({navigation}: {navigation: any}) => {
    ...
    const handleClickUno = () => { setColourUno(getColour()); }
    const handleClickDos = () => { setColourDos(getColour()); }
    const handleClickTres = () => { setColourTres(getColour()); }
    const handleClickCuatro = () => { setColourCuatro(getColour()); }
        ...
        <View style={styles.container}>
            <SafeAreaView>
                ...
                <View style={styles.header}>
                    <TouchableOpacity onPress={() => alert('No te vayas, no seas mamón')}>
                ...
                <View style={styles.headerCirculos}>
                    ...
                    <TouchableOpacity style={[styles.circUno, { backgroundColor: colourCuatro }]} onPress={handleClickCuatro} disabled={true}/>
